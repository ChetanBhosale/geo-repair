...
1. Can the page rank and be discovered?
2. Can the page be fetched without JavaScript?
3. Can the answer be extracted quickly?
4. Does the page prove why it should be trusted?
5. Are trusted third-party sources reinforcing the same entity and category signals?
