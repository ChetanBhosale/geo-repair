Next.js can be excellent for AI search readiness, but only when the important content is rendered in the right place. A Next.js site can also hide critical text behind client components, client-side fetches, and interactive states that crawlers never execute.

The audit should be route-by-route and source-of-truth driven.
...
That is the core Next.js audit: visible content, crawlable HTML, accurate metadata, valid schema, and no accidental blocks.
