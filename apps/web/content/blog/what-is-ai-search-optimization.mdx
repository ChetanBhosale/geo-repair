...
The two disciplines overlap (clean HTML and good metadata help both), but the bar for AI search is _legibility to a machine that reads, not just indexes._
