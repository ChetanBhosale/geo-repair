...
A mention means an AI answer names your brand. A citation means the answer links to a URL. Both can be valuable, but they point to different parts of the buyer journey and different fixes.
...
But a mention without a source is fragile. It may come from broad brand memory, third-party content, older training data, or uncited retrieval. You get visibility, but you do not get a retrievable URL attached to the answer.
...
Citations are not automatically more valuable than mentions for every business. A brand recommendation without a click can still influence demand. But citations give you stronger evidence about what content is being retrieved.
