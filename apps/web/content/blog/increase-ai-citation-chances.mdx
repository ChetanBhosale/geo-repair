...
1. Is the main answer visible in no-JavaScript HTML?
2. Does the title, meta description, h1, and first paragraph all describe the same intent?
3. Does the page include structured data that matches the visible content?
4. Is the page listed in sitemap.xml and, if relevant, llms.txt?
5. Does the page contain a short answer a model could quote without misrepresenting you?
