...
Those answers should be present in server-rendered text. Images, carousels, empty accordions, and JavaScript-only state should not be the only place they appear.
