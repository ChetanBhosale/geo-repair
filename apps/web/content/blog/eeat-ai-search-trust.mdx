...
2. Add a real example.
3. Explain the tradeoffs.
4. Show who wrote or owns the advice.
5. Update the date when facts change.
6. Add schema that accurately describes the page.
7. Link to deeper supporting pages.
