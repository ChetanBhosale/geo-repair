...
description: "Run the checkup for nothing. Pay a single one-time fee, sized to your site, only when you want the agent to ship the fixes."
source: https://geo.repair/pricing
---

# Free to check. Pay once to fix.
...
_No signup or card required_

## A one-time fix, sized to your site
...
- **Starter** (Up to 25 pages): $49
- **Growth** (Up to 100 pages): $149
- **Scale** (Up to 250 pages): $399
- **Enterprise** (250+ pages): Custom
...
### What if the fix can't be applied?
...
### Do you guarantee more traffic or AI citations?
...
_Markdown copy of [Free to check. Pay once to fix.](https://geo.repair/pricing), a faithful text version of the page for machines and readers. © GEO Repair._
